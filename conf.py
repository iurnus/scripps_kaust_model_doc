...
project = u'SKRIPS Model User Guide'
...
latex_documents = [
  ('index', 'SKRIPS.tex', u'SKRIPS Model User Guide',
...
man_pages = [
    ('index', 'SKRIPS', u'SKRIPS Model Documentation',
...
texinfo_documents = [
  ('index', 'SKRIPS', u'SKRIPS Model User Guide',
